...
loading, setLoading, municipios, idMunicipio, setIdMunicipio, onValidityChange}, ref) => {
    ...
    useEffect(() => {
        onValidityChange?.(Boolean(idMunicipio && idClase))
    }, [idMunicipio, idClase, onValidityChange])
